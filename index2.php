...
<section class="categories">
    <div class="container">
        <h2 class="text-center">Explore our wide variety of cuisines </h2>
        <h2 class="text-center">from around the world!</h2>
        <?php 
        ...
        <div class="food-menu-box">
            <div class="food-menu-img">
                ...
                <img src="<?php echo SITEURL; ?>images/food/<?php echo $image_name; ?>"
                    alt="Image Not avaliable Currently" class="img-responsive img-curve">
                <?php
                            }
                        ?>
